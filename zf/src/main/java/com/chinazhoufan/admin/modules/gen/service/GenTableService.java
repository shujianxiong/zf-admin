...
import com.chinazhoufan.admin.modules.gen.dao.GenDataBaseDictDao;
...
public class GenTableService extends BaseService {
	...
	@Transactional(readOnly = false)
	public void delete(GenTable genTable) throws DataIntegrityViolationException{
	...
	public void remove(GenTable genTable){
		genTableDao.remove(genTable);
		genTableColumnDao.removeByGenTableId(genTable.getId());
	}
