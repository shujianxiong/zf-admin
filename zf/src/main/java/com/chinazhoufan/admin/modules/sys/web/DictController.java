...
public class DictController extends BaseController {
	...
	public String delete(Dict dict, RedirectAttributes redirectAttributes) {
		...
		if(dict == null || StringUtils.isBlank(dict.getId())) {
			addMessage(redirectAttributes, "友情提示：未能获取到要删除的字典信息！");
			return "error/400";
		}
	...
	@RequiresPermissions("user")
	@ResponseBody
	@RequestMapping("listByTypeAndValueLike")
	public String listByTypeAndValueLike(String type, String value, Model model) {
		List<Dict> dictList = dictService.listByTypeAndValueLike(type, value);
		return JsonMapper.toJsonString(dictList);
	}
