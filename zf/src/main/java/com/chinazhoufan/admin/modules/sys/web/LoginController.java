...
//		try {
//			byte[] bytes = com.chinazhoufan.admin.common.utils.FileUtils.readFileToByteArray(
//					com.chinazhoufan.admin.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
...
//		System.out.println("==========================b");
		String themeType = CookieUtils.getCookie(request, "themeType");
		if("0".equals(themeType))
			return "modules/sys/_sysIndex";
		else
			return "modules/sys/sysIndex";
	}
	...
	public String getThemeInCookie(@PathVariable String theme, HttpServletRequest request, HttpServletResponse response){
		if("responsive".equals(theme)){
			CookieUtils.setCookie(response, "themeType", "0");
			theme="";
		}else{
			CookieUtils.setCookie(response, "themeType", "1");
		}
