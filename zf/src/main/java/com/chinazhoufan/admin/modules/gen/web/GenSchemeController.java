 ...
 */
package com.chinazhoufan.admin.modules.gen.web;
...
import com.chinazhoufan.admin.modules.gen.service.GenSchemeService;
import com.chinazhoufan.admin.modules.gen.service.GenTableService;
...
public class GenSchemeController extends BaseController {
	...
	public String form(GenScheme genScheme, Model model) {
		if (StringUtils.isBlank(genScheme.getPackageName())){
			genScheme.setPackageName("com.chinazhoufan.admin.modules");
		}
...
//		}
		...
		System.out.println(genTableService.findAll().size());
