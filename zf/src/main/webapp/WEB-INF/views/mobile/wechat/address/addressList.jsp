...
<body>
	<!-- <div class="address_head" >
		<span id="" class="head_select">
			选择收货地址
		</span>
		<span id="" class="head_manage">
			管理收货地址
		</span>
	</div> -->
	<div id="addressWrapper" class="addressWrapper">
		<div id="addressScroll" class="addressScroll">
			<div id="addressContent" class="address_list" >
				<div id="loading" class="loading">
					<img style="height: 26px;width: 26px;margin: 2px       10px;float: none;" src="${ctxMobile}/pages/address/images/loading.gif"/>正在载入...
				</div>
			</div>
			<div class="address_button">添加新地址</div>
		</div>
	</div>
<%@ include file="/WEB-INF/views/mobile/include/viewPanel.jsp"%>
</body>
<script src="${ctxMobile}/pages/address/addressList.js" type="text/javascript" ></script>
</html>