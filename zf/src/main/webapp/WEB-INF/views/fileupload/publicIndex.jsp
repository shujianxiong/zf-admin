...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="fileContent" src="${ctx}/bas/fileLibrary/uploadView?selectMultiple=${selectMultiple}" width="100%" height="91%" frameborder="0">
	...
	<script type="text/javascript">
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					$('#fileContent').attr("src","${ctx}/bas/fileLibrary/uploadView?fileDirId="+id+"&selectMultiple="+${selectMultiple});
				}
			}
		};
		...
		function refreshTree(){
			...
			$("#loading").show();
			$.getJSON("${ctx}/bas/fileDir/treeData/public",function(data){
				$("#loading").hide();
