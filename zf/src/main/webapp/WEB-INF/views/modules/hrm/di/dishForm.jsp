    ...
    <section class="content-header content-header-menu">
    	 <h1>
            ...
            <small class="menu-active">
                <i class="fa fa-repeat"></i><a href="${ctx}/hrm/di/dish/form?id=${dish.id}&dietId=${dish.diet.id}">菜品${not empty dish.id?'修改':'添加'}</a>
            </small>
        </h1>
    </section>
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group    ">
                                ...
                                <div class="col-sm-9">
                                    <sys:selectverify name="type" tip="请选择三餐类型，必填项" verifyType="0" dictName="hrm_di_mealType" id="typeSelect"></sys:selectverify>
                                </div>
                            </div>
                            <div class="form-group    ">
                                <label class="col-sm-2 control-label">菜品名称</label>
                                <div class="col-sm-9">
                                    <sys:inputverify id="name" name="name" tip="请输入菜品名称" verifyType="0"  isSpring="true"></sys:inputverify>
                                </div>
                            </div>
                            <div class="form-group    ">
                                <label class="col-sm-2 control-label">评价得分</label>
                                <div class="col-sm-9">
                                    <sys:inputverify id="score" name="score" tip="请输入评价得分" verifyType="-1"  isSpring="true" forbidInput="true" isMandatory="false"></sys:inputverify>
                                </div>
                            </div>
                            <div class="form-group    ">
                        ...
                        <div class="box-footer">
                            ...
                            <div class="pull-right box-tools">
                                ...
                                <shiro:hasPermission name="hrm:di:dish:edit"><button type="submit" class="btn btn-info btn-sm"><i class="fa fa-save"></i>保存</button></shiro:hasPermission>
                            </div>
                        </div>
                    </div>
                </form:form>
