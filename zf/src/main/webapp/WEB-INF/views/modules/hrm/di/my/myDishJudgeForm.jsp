...
<body>
    ...
    <section class="content-header content-header-menu">
        <h1>
            ...
            <shiro:hasPermission name="hrm:di:dishJudge:edit">
	            <small>|</small>
                <small class="menu-active">
                    <i class="fa fa-repeat"></i><a href="${ctx}/hrm/di/myDish/judgeForm?id=${dishJudge.id}&dishId=${dishJudge.dish.id}">菜品评价${not empty dishJudge.id?'修改':''}</a>
                </small>
            </shiro:hasPermission>
        </h1>
    </section>
            ...
            <div class="col-md-6">
                <form:form id="inputForm" modelAttribute="dishJudge" action="${ctx}/hrm/di/myDish/judgeSave" method="post" class="form-horizontal" onsubmit="return ZF.formSubmit();">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <form:hidden path="id" />
                            <form:hidden path="dish.id" />
                            <form:hidden path="dish.diet.id" />
                        ...
                        <div class="box-footer">
                            ...
                            <div class="pull-right box-tools">
                                <c:if test="${empty dishJudge.id}">
                                    <button type="button" class="btn btn-default btn-sm" onclick="ZF.resetForm()"><i class="fa fa-refresh"></i>重置</button>
                                </c:if>
                                <shiro:hasPermission name="hrm:di:dishJudge:edit"><button type="submit" class="btn btn-info btn-sm"><i class="fa fa-save"></i>保存</button></shiro:hasPermission>
                            </div>
                        </div>
                    </div>
                </form:form>
