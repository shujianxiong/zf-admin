...
<div class="content-wrapper sub-content-wrapper">
    ...
    <form:form id="inputForm" modelAttribute="activityRecord" action="${ctx}/spm/ai/activityRecord/info" method="post" class="form-horizontal">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <strong>会员ID</strong>
                            <p class="text-primary">
                                ${activityRecord.member.id}
                            </p>
                            <hr class="zf-hr">
                            <strong>更新者</strong>
                            <p class="text-primary">
                                ${activityRecord.updateBy.id}
                            </p>
                            <hr class="zf-hr">
                            <strong>更新时间</strong>
                            <p class="text-primary">
