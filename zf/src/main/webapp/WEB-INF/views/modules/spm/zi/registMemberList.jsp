	...
	<div class="content-wrapper sub-content-wrapper">
		<section class="content-header content-header-menu">
	      <h1>
			  ...
			  <small>|</small>
			<small class="menu-active"><i class="fa fa-repeat"></i><a href="${ctx}/spm/zi/qrCode/registerMemberList?openIds=${openids}">已注册会员列表</a></small>
	      </h1>
	    </section>
	    <sys:tip content="${message}"/>
	    <section class="content">
		    <form:form id="searchForm" modelAttribute="member" action="${ctx}/crm/sl/smsLink/registerMemberList?openIds=${openids}" method="post" class="form-horizontal">
