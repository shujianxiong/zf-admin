...
<body>
    ...
    <section class="content-header content-header-menu">
        <h1>
            <small><i class="fa-list-style"></i><a href="${ctx}/spm/ai/activityRecord/">活动参与记录列表</a></small>
            <shiro:hasPermission name="spm:ai:activityRecord:edit">
	            <small>|</small>
                <small class="menu-active">
                    <i class="fa fa-repeat"></i><a href="${ctx}/spm/ai/activityRecord/form?id=${activityRecord.id}">活动参与记录${not empty activityRecord.id?'修改':'添加'}</a>
                </small>
            </shiro:hasPermission>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                <form:form id="inputForm" modelAttribute="activityRecord" action="${ctx}/spm/ai/activityRecord/save" method="post" class="form-horizontal" onsubmit="return ZF.formSubmit();">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <form:hidden path="id" />
                                ...
                                <div class="form-group    ">
                                    ...
                                    <div class="col-sm-9">
                                        <sys:inputverify id="activity.id" name="activity.id" tip="请输入活动ID" verifyType="0"  isSpring="true"></sys:inputverify>
                                    </div>
                                </div>
                                <div class="form-group    ">
                        ...
                        <div class="box-footer">
                            ...
                            <div class="pull-right box-tools">
                                <c:if test="${empty activityRecord.id}">
                                    <button type="button" class="btn btn-default btn-sm" onclick="ZF.resetForm()"><i class="fa fa-refresh"></i>重置</button>
                                </c:if>
                                <shiro:hasPermission name="spm:ai:activityRecord:edit"><button type="submit" class="btn btn-info btn-sm"><i class="fa fa-save"></i>保存</button></shiro:hasPermission>
                            </div>
                        </div>
                    </div>
                </form:form>
