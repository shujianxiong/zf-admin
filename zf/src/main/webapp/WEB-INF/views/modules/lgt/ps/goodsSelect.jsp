    ...
    <div class="content-wrapper sub-content-wrapper">
        <section  class="content">
            <div class="box box-info"> 
                ...
                <form:form id="searchForm" modelAttribute="goods" action="${ctx}/lgt/ps/goods/select" method="post" class="form-horizontal">
	                        ...
	                        <table id="contentTable" class="table table-bordered table-hover table-striped zf-tbody-font-size">
	                            ...
	                            <tbody id="tBodyId">
									<c:forEach items="${page.list}" var="goods">
										<tr id="${goods.id }" data-type="item">
											<td  data-type="checkbox">
												<input type="checkbox" name="selectName" id="input_${goods.id }" data-goods="${goods.id}=${goods.code}=${goods.name}=${fns:getDictLabel(goods.status, 'lgt_ps_goods_status', '')}=${goods.samplePhoto}=${goods.designer.id}=${goods.designer.name}" value="${goods.id}"/>
											</td>
											<td>
											    ${goods.code}
											</td>
