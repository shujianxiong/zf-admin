...
<div class="content-wrapper sub-content-wrapper">
	<section class="content-header">
		<h1>
	        <small class="menu-active">
	        	<i class="fa fa-repeat"></i><a href="${ctx}/lgt/ps/produce/selectRadio?warehouseId=${warehouseId }">仓库产品列表</a>
	        </small>
      	</h1>
	</section>
	...
	<section class="content">
		<form:form id="searchForm" modelAttribute="produce" action="${ctx}/lgt/ps/produce/selectRadio" method="post" class="form-horizontal">
							...
							<c:forEach items="${page.list}" var="produce">
								<tr id="${produce.id }" data-type="item">
									<td  data-type="checkbox">
										<input type="radio" name="selectName" value="${produce.id }" data-code="${produce.code}" data-name="${produce.name}" data-fullname="${produce.goods.name} ${produce.name}"/>
									</td>
									<td>
										${produce.code}
									</td>
