	...
	<script type="text/javascript">
		...
		function addRow(){
			...
			if(ths.length <= 1 || data.length < 1){
				ZF.showTip("请先在商品属性里面选择SKU规格类参数<br/>如若没有，请在“属性管理”菜单中设置该商品对应分类的【价格决策类】","info");
				return;
			}
		...
		function formSubmit(){
            ...
            if(trSize == 0) {
            	ZF.showTip("产品规格不允许为空，请仔细核对！<br/> 请先选择【商品属性】里面的【SKU规格类】参数 ","warning");
                verifyPass = false;
            } else {
				...
				<div class="col-md-12">
					<div class="box box-success">
	    				...
	    				<div class="box-body">
							...
							<div class="row">
								<div class="form-group">
									<label for="searchParam" class="col-sm-1 control-label text-blue" >SKU规格类
