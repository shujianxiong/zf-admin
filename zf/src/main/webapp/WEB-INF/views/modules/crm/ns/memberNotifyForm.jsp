...
<body>
    ...
    <section class="content-header content-header-menu">
        <h1>
            <small><i class="fa-list-style"></i><a href="${ctx}/crm/ns/memberNotify/">会员消息列表</a></small>
            <shiro:hasPermission name="crm:ns:memberNotify:edit">
	            <small>|</small>
                <small class="menu-active">
                    <i class="fa fa-repeat"></i><a href="${ctx}/crm/ns/memberNotify/form?id=${memberNotify.id}">会员消息${not empty memberNotify.id?'修改':'添加'}</a>
                </small>
            </shiro:hasPermission>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                <form:form id="inputForm" modelAttribute="memberNotify" action="${ctx}/crm/ns/memberNotify/save" method="post" class="form-horizontal" onsubmit="return ZF.formSubmit();">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <form:hidden path="id" />
                                ...
                                <div class="form-group    ">
                                    ...
                                    <div class="col-sm-9">
                                        <sys:inputverify id="title" name="title" tip="请输入标题" verifyType="0"  isSpring="true"></sys:inputverify>
                                    </div>
                                </div>
                                <div class="form-group    ">
                                ...
                                <div class="form-group    ">
                                    <label class="col-sm-2 control-label">查看标记</label>
                                    <div class="col-sm-9">
                                        <sys:inputverify id="readFlag" name="readFlag" tip="请输入查看标记" verifyType="0"  isSpring="true"></sys:inputverify>
                                    </div>
                                </div>
                                <div class="form-group    ">
                                    <label class="col-sm-2 control-label">查看时间</label>
                                    <div class="col-sm-9">
                                        <sys:datetime id="readTime" inputName="readTime" tip="请选择查看时间" inputId="readTimeId" isMandatory="true" value="${memberNotify.readTime}"></sys:datetime>
                                    </div>
                                </div>
                                <div class="form-group    ">
                        ...
                        <div class="box-footer">
                            ...
                            <div class="pull-right box-tools">
                                <c:if test="${empty memberNotify.id}">
                                    <button type="button" class="btn btn-default btn-sm" onclick="ZF.resetForm()"><i class="fa fa-refresh"></i>重置</button>
                                </c:if>
                                <shiro:hasPermission name="crm:ns:memberNotify:edit"><button type="submit" class="btn btn-info btn-sm"><i class="fa fa-save"></i>保存</button></shiro:hasPermission>
                            </div>
                        </div>
                    </div>
                </form:form>
