...
<div class="content-wrapper sub-content-wrapper">
		...
		<h1>
			...
			<shiro:hasPermission name="crm:bb:bankbookTemp:edit">
				...
				<small><i class="fa-form-edit"></i><a
					href="${ctx}/crm/bb/bankbookTemp/form">资金账户条目添加</a></small>
			</shiro:hasPermission>
		</h1>
	</section>
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <form:form id="searchForm" modelAttribute="bankbookTemp" action="${ctx}/crm/bb/bankbookTemp/" method="post" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div  class="form-group">
                                ...
                                <div class="col-sm-7">  
                                    <sys:datetime id="beginTime" inputName="beginTime" tip="请选择创建开始时间" inputId="beginTime" value="${bankbookTemp.beginTime }" isMandatory="false"></sys:datetime>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <div  class="form-group">
                                ...
                                <div class="col-sm-7">  
                                    <sys:datetime id="endTime" inputName="endTime" tip="请选择创建截止时间" inputId="endTime" value="${bankbookTemp.endTime }" isMandatory="false"></sys:datetime>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <c:when test="${bankbookTemp.status eq '1'}">
		                                        <div class="btn-group zf-tableButton">
		                                            <button type="button" class="btn btn-sm btn-info"
		                                                onclick="window.location.href='${ctx}/crm/bb/bankbookTemp/form?id=${bankbookTemp.id}'">修改</button>
		                                            <button type="button"
		                                            ...
		                                            <ul class="dropdown-menu btn-info zf-dropdown-width" role="menu">
		                                                ...
		                                                <li><a href="${ctx}/crm/bb/bankbookTemp/info?id=${bankbookTemp.id}" target="">详情</a></li>
		                                            </ul>
		                                        </div>
                                            </c:when>
                                            <c:otherwise>
