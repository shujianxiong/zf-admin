...
<div class="content-wrapper sub-content-wrapper">
	...
	<section class="content">
		<div class="row">
			<div class="col-md-6">
				<form:form id="inputForm" modelAttribute="media" action="${ctx}/re/mp/resources/mesUp" method="post" class="form-horizontal" onsubmit="return ZF.formSubmit();" enctype="multipart/form-data">
