...
<div class="content-wrapper sub-content-wrapper">
    <section class="content-header content-header-menu">
        <h1>
            <small class="menu-active"><i class="fa fa-repeat"></i><a href="${ctx}/ser/as/workorder/">售后工单列表</a></small>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <form:form id="searchForm" modelAttribute="workorder" action="${ctx}/ser/as/workorder/" method="post" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div  class="form-group">
                                ...
                                <div class="col-sm-7">  
                                    <sys:inputverify name="member.usercode" id="usercode" verifyType="99" tip="请输入会员账号" isMandatory="false" isSpring="true"></sys:inputverify>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <tbody>
                            <c:forEach items="${page.list}" var="workorder" varStatus="status">
                                <tr data-index="${status.index }">
                                    ...
                                    <td title="${workorder.description }">${fns:abbr(workorder.description,20)}</td>
                                    <td data-hide="true">
