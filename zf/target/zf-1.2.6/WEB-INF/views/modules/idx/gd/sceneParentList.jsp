...
<div class="content-wrapper sub-content-wrapper">
    <section class="content-header content-header-menu">
        <h1>
            <small class="menu-active"><i class="fa fa-repeat"></i><a href="${ctx}/idx/gd/scene/findParentList">场景列表</a></small>
            <shiro:hasPermission name="idx:gd:scene:edit">
	            <small>|</small>
                <small>
                    <i class="fa-form-edit"></i><a href="${ctx}/idx/gd/scene/form">场景添加</a>
                </small>
            </shiro:hasPermission>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <form:form id="searchForm" modelAttribute="scene" action="${ctx}/idx/gd/scene/findParentList" method="post" class="form-horizontal">
                                    ...
                                    <shiro:hasPermission name="idx:gd:scene:edit"><td>
                                        <div class="btn-group zf-tableButton">
                                            ...
                                            <ul class="dropdown-menu btn-info zf-dropdown-width" role="menu">
                                                <li><a href="${ctx}/idx/gd/scene/updateFlag?id=${scene.id}&type=I" target="">${scene.indexFlag eq '1'?'取消推荐':'推荐' }</a></li>
                                                <li><a href="${ctx}/idx/gd/scene/updateFlag?id=${scene.id}&type=U" target="">${scene.usableFlag eq '1'?'停用':'启用' }</a></li>
                                                <li><a href="${ctx}/idx/gd/scene/findSubList?scene.id=${scene.id}" target="">子场景管理</a></li>
                                                <c:if test="${scene.usableFlag eq '0' }">  <!-- 非启用状态可以删除 -->
                                                    <li><a href="${ctx}/idx/gd/scene/delete?id=${scene.id}" style="color: #fff" onclick="return ZF.delRow('确定要删除该场景吗？',this.href)">删除</a>
                                                    </li>
                                                </c:if>
