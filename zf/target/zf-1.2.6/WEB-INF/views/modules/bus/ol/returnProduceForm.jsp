...
<body>
    ...
    <section class="content-header content-header-menu">
        <h1>
            <small><i class="fa-list-style"></i><a href="${ctx}/bus/ol/returnProduce/">退货产品列表</a></small>
            <shiro:hasPermission name="bus:ol:returnProduce:edit">
	            <small>|</small>
                <small class="menu-active">
                    <i class="fa fa-repeat"></i><a href="${ctx}/bus/ol/returnProduce/form?id=${returnProduce.id}">退货产品${not empty returnProduce.id?'修改':'添加'}</a>
                </small>
            </shiro:hasPermission>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-6">
                <form:form id="inputForm" modelAttribute="returnProduce" action="${ctx}/bus/ol/returnProduce/save" method="post" class="form-horizontal" onsubmit="return ZF.formSubmit();">
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            <form:hidden path="id" />
                                ...
                                <div class="form-group    ">
                                    ...
                                    <div class="col-sm-9">
                                        <sys:inputverify id="returnOrder.id" name="returnOrder.id" tip="请输入退货单ID" verifyType="0"  isSpring="true"></sys:inputverify>
                                    </div>
                                </div>
                                <div class="form-group    ">
                        ...
                        <div class="box-footer">
                            ...
                            <div class="pull-right box-tools">
                                <c:if test="${empty returnProduce.id}">
                                    <button type="button" class="btn btn-default btn-sm" onclick="ZF.resetForm()"><i class="fa fa-refresh"></i>重置</button>
                                </c:if>
                                <shiro:hasPermission name="bus:ol:returnProduce:edit"><button type="submit" class="btn btn-info btn-sm"><i class="fa fa-save"></i>保存</button></shiro:hasPermission>
                            </div>
                        </div>
                    </div>
                </form:form>
