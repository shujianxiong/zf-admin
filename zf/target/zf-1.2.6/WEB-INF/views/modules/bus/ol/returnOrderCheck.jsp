...
<div class="content-wrapper sub-content-wrapper">
    <section class="content-header content-header-menu">
        <h1>
            <small class="menu-active"><i class="fa fa-repeat"></i><a href="${ctx}/bus/ol/returnOrder/bagCheck">包裹质检</a></small>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div  class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" data-name = "expressNoTemp" name="expressNoTemp" id="expressNoTemp" placeholder="请扫描录入物流单号" class="form-control zf-input-readonly" t>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <c:if test="${returnOrder.status eq '3'  or returnOrder.status eq '5' }">
		                                            <ul class="dropdown-menu btn-info zf-dropdown-width" role="menu">
		                                               <c:if test="${returnOrder.status eq '3' }">
                                                           <shiro:hasPermission name="bus:ol:bagCheck:view">
                                                               <li><a href="${ctx}/bus/ol/returnOrder/toCheck?id=${returnOrder.id}&returnOrderNo=${returnOrder.returnOrderNo}">包裹核对</a></li>
                                                           </shiro:hasPermission>
		                                               </c:if>
    ...
    <script>
      $(function () {
          $("[data-name =expressNoTemp]").focus();//给定默认光标
        ZF.bigImg();
          $("#expressNoTemp").on("change", function() {
              ...
              if(expressNo == null || expressNo == "" || expressNo == undefined) {
                  ...
                  window.location.href="${ctx}/bus/ol/returnOrder/scanBag?expressNo="+expressNo;
              }
          });
        $('input').iCheck({
      ...
      function scan() {
          ...
          window.location.href="${ctx}/bus/ol/returnOrder/scanBag?expressNo="+expressNoTemp;
      }
   </script>
</body>
</html>