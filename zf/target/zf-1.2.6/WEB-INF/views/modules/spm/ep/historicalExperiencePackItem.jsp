...
<div class="content-wrapper sub-content-wrapper">
    ...
    <section class="content">
        <div class="box box-info">
            <form:form id="searchForm" modelAttribute="experiencePackItem" action="${ctx}/spm/ep/experiencePackItem/historicalExperiencePackage" method="post" class="form-horizontal">
                <input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
                <input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
                <input name="id" type="hidden" value="${experiencePackItem.id}"/>
            </form:form>
        </div>
                        ...
                        <tbody>
                            <c:forEach items="${page.list}" var="experiencePackItem" varStatus="status">
                                <tr data-index="${status.index }">
                                    ...
                                    <td>
                                        <span class="label label-primary">${fns:getDictLabel(experiencePackItem.payType, 'experience_pack_pay_type', '')}</span></td>
                                    <td>
