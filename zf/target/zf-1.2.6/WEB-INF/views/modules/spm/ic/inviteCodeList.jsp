...
<body>
	<div class="content-wrapper sub-content-wrapper">
		<section class="content-header content-header-menu">
			 <h1>
				<small class="menu-active"><i class="fa fa-repeat"></i><a href="${ctx}/spm/ic/inviteCode/list">我的邀请码列表</a></small>
				
				<shiro:hasPermission name="spm:ic:inviteCode:edit"><small>|</small><small><i class="fa-form-edit"></i><a href="${ctx}/spm/ic/inviteCode/form">邀请码${not empty inviteCode.id?'修改':'添加'}</a></small></shiro:hasPermission>
		      </h1>
		</section>
		...
		<section class="content">
			<form:form id="searchForm" modelAttribute="inviteCode" action="${ctx}/spm/ic/inviteCode/list" method="post" class="form-horizontal">
		    	<input id="pageNo" name="pageNo" type="hidden" value="${page.pageNo}"/>
				<input id="pageSize" name="pageSize" type="hidden" value="${page.pageSize}"/>
				<input type="hidden" name="createrId" value="${inviteCode.createrId }"/>
...
<!-- 								<td> -->
<%-- 									${fns:getUserById(inviteCode.createrId).id} --%>
<!-- 								</td> -->
								<td>
