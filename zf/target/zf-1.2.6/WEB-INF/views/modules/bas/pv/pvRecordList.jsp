...
<div class="content-wrapper sub-content-wrapper">
    <section class="content-header content-header-menu">
        <h1>
            <small class="menu-active"><i class="fa fa-repeat"></i><a href="${ctx}/bas/pv/pvRecord/">页面访问记录列表</a></small>
        </h1>
    </section>
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <form:form id="searchForm" modelAttribute="pvRecord" action="${ctx}/bas/pv/pvRecord/" method="post" class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div  class="form-group">
                                ...
                                <div class="col-sm-7">  
                                    <sys:datetime id="starTime" inputName="searchParameter.starTime" tip="请选择开始时间" value="${pvRecord.searchParameter.starTime }" inputId="starTimeId"></sys:datetime>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
            ...
            <div class="box-body">
                <div class="table-responsive">
                    <table id="contentTable" class="table table-bordered table-hover table-striped zf-tbody-font-size">
                        ...
                        <tbody>
                            <c:forEach items="${page.list}" var="pvRecord" varStatus="status">
                                <tr data-index="${status.index }">
                                    <td>
                                        ${fns:getDictLabel(pvRecord.pageType, 'bas_pv_record_pageType', '无')}
                                    </td>
                                    <td>
                                        ${pvRecord.count}
                                    </td>
