	...
	<form:form id="inputForm" modelAttribute="test" action="${ctx}/test/test/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:hidden id="imageName" path="imageName" htmlEscape="false" maxlength="255" class="form-control"/>
                <sys:fileUpload input="imageName" model="true" selectMultiple="false"></sys:fileUpload>
                
                <form:hidden id="fileName" path="fileName" htmlEscape="false" maxlength="255" class="form-control"/>
                <sys:fileUpload input="fileName" model="true" selectMultiple="true"></sys:fileUpload>
