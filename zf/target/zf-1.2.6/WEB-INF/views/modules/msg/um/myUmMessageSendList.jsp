	...
	<div class="content-wrapper sub-content-wrapper">
	    ...
	    <section class="content-header content-header-menu">
	      <h1>
	        ...
	        <small>|</small>
	        <small class="menu-active"><i class="fa fa-repeat"></i><a  href="${ctx}/msg/um/myUmMessage/sendList">发件箱</a></small>
	        <small>|</small>
	    ...
	    <section class="content">
	    	<form:form id="searchForm" modelAttribute="umMessage" action="${ctx}/msg/um/myUmMessage/sendList" method="post" class="form-horizontal">
