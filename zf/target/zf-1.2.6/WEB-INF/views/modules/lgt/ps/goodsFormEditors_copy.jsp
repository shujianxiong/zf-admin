...
// 				}
// 				if(prop.valueType=="0"&&goodsProp[i].goodsPropvalue!=null&&goodsProp[i].goodsPropvalue.length>=1){
...
// 			var temp="<div id=\"$idPanel\" class=\"col-md-4\"><div class=\"form-group\"><label class=\"col-sm-3 control-label\">$propName</label>"+
	    					...
	    					<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<div class="col-sm-8 zf-check-wrapper-padding">
											<form:radiobuttons path="isCouponUsable" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" />
										</div>
									</div>
								</div>
								<div class="col-md-6">
								...
								<div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8 zf-check-wrapper-padding">
                                            <form:radiobuttons path="isRepresentative" items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" />
                                        </div>
                                    </div>
                                </div>
	    					</div>
