	      ...
	      <h1>
	        <small><i class="fa-list-style"></i><a href="${ctx}/lgt/ps/goods/list">商品列表</a></small>
			  <shiro:hasPermission name="lgt:ps:goods:edit">
				  <small>|</small>
				  <small class="menu-active"><i class="fa fa-repeat"></i><a href="#this" onclick="location.reload();">在线修改</a></small>
			  </shiro:hasPermission>
		  </h1>
	    </section>
	    <sys:tip content="${message}"/>
		<section class="content">
			<form:form id="inputFormNew" modelAttribute="goods" action="${ctx}/lgt/ps/goods/updateNew" method="post" class="form-horizontal" onsubmit="return formSubmit()">
			<form:hidden path="id"/>
	    					...
	    					<div class="row">
		    					<div class="col-md-4">
		    						<div class="form-group">
										...
										<div class="col-sm-8">
											<sys:inputverify id="nameInput" name="name" tip="请输入商品名称，必填项" verifyType="99" isSpring="true" forbidInput="true"   ></sys:inputverify>
										</div>
		    						</div>
		    					</div>
		    					<div class="col-md-4">
		    						<div class="form-group">
										...
										<div class="col-sm-8">
											<sys:inputverify id="englishNameInput" name="englishName" tip="请输入商品英文名称" verifyType="99" isMandatory="false" isSpring="true" forbidInput="true"></sys:inputverify>
										</div>
		    						</div>
		    					</div>
		    					<div class="col-md-4">
		    						<div class="form-group">
										...
										<div class="col-sm-8">
											<sys:inputverify id="titleInput" name="title" tip="请输入展示标题，必填项" verifyType="99" isSpring="true" forbidInput="true"></sys:inputverify>
										</div>
		    						</div>
		    					</div>
	    					</div>
                            ...
                            <div class="row">	
		    					...
		    					<div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <sys:selectverify name="useRange" tip="请选择使用范围" verifyType="0" dictName="useRange" id="useRange" disabled="true"  ></sys:selectverify>
                                        </div>
                                    </div>
                                </div>
                            </div>
	    				...
	    				<div class="box-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <form:textarea path="story" htmlEscape="false" rows="4" maxlength="255" class="form-control " disabled="true"/>
                                    </div>
                                </div>
                            </div>
                        </div>
							<div class="row">
								<div class="col-md-6">
									<sys:inputtree name="deo.id" url="${ctx}/bas/video/videoTreeData?type=1" id="deo" label="视频选择" labelValue="" labelWidth="2" inputWidth="8"
												   labelName="deo.code" value="" tip="请选择视频" isReadOnly="true" ></sys:inputtree>
								</div>
							</div>
                        <div class="row">
                               <div class="col-md-12">
                                   <div class="form-group">
                                       ...
                                       <div class="col-sm-8">
										   ...
										   <img onerror="imgOnerror(this);"  class="img-responsive" src="${imgHost }${goods.samplePhoto }" alt="icon">
                                       </div>
                                   </div>
                               </div>
                           </div>
