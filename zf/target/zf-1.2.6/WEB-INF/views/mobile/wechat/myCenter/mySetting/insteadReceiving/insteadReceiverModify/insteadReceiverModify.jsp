...
<head>
    ...
    <link rel="stylesheet/less" href="${ctxMobile}/pages/myCenter/mySetting/insteadReceiving/insteadReceiverModify/insteadReceiverModify.less" />
...
<body>
<div class="input">
	<input type="tel" placeholder="请输入代收货人新手机号" ></input>
	<p>代收货人只能修改手机号，请您认真核对</p>
</div>
<div class="button">保存</div>
</body>
    <script src="${ctxMobile}/pages/myCenter/mySetting/insteadReceiving/insteadReceiverModify/insteadReceiverModify.js" type="text/javascript" ></script>
</html>