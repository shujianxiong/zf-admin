...
<body>
	...
	<form action="${ctxWeb}/member/doModifiedPassword" method="post" name="resetPasswordForm">
	<div class="login_bac">
		<div class="login_input">
			<div class="input">
				<input type="hidden" data-notnull value="${centerVO.member.mobile}" name="phone" readOnly="true"></input>
			</div>
			<input type="password" data-notnull placeholder="密码长度6~14位,数字,字母,至少包含两种1" id="passWord" maxlength="50" name="pwd"></input>
