...
<head>
    ...
    <script src="${ctxMobile}/pages/loginRegist/modifiedPassword.js" type="text/javascript" ></script>
</head>
<body>
	<input type="text" id="status" value="${echos.status }" style="display:none"/>
	<form action="${ctxWeb }/member/modifiedPassword" method="post" name="modifiedPasswordForm">
	<div class="register">
		<div class="input">
			<input type="tel" data-notnull placeholder="请输入手机号" value="${centerVO.member.mobile}" id="telephone" name="phone" ></input>
		</div>
